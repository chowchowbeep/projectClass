...
<script type="text/javascript" >
	...
	//사용자 삭제 요청
	function userDelete() {
		//삭제 버튼 클릭_ on함수에 대해서는 event.jsp와 onEvent.jsp를 참조하세요
		$('body').on('click','#btnDelete',function(){ 
			var userId = $(this).closest('tr').find('#hidden_userId').val(); //closest가장가까운 부모태그찾기
...
<body><!--  layout.jsp의 <decorator:body />에 들어갈 것임--> 
<div class="container">
